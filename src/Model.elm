module Model exposing (Model,ArrowKey(..),Doorstate(..),Plate,Block,Door,Property,Ball,Line,Bricks,State(..),Dir(..),init_model1,model_init,getBrickPos,model_level1,model_level2,model_level3,init_model2,init_model3)
...
init_Map1  = 
    let
        ...
        l9 = List.concat[l1,l2,l3,l4,l5,l6,l7,l8,getline (175,200) (200,0) 2]
        l10 = getline (125,150) (100,0) 4
        l11 = getline (175,300) (200,0) 2
        l12 = getline (275,100) (0,0) 1
        l = List.concat [l9,l10,l11,l12]
...
init_Map3 =    
    let     
        ...
        l3 = List.concat[l1,l2,l22,l222,getline (525,125) (0,50) 4]
        l33 = getline (475,325) (-50,50) 4
        l333 = getline (525,325) (-50,50) 5
        l4 = getline (225,125) (100,0) 2
        l5 = getline (225,175) (50,0) 3
        l6 = List.concat[l3,l33,l333,l4,l5,getline (125,125) (300,0) 2]
...
init_Map2 =    
    let     
        ...
        l = List.concat[ List.concat[l1,l111,l2,l3,l33,l333,l4,l44,l5,l6],List.concat[l66,l7,l8,l9,l22,l10,l11,l12,l13,l14,l15]]
        ...
        lb = List.concat[[11,12,14,15,16,17],[18,19,35,36,39,40]]
        ncolor = changeColor color lb 1
    in
        zip l ncolor
...
init_model1 model = 
    Model 0 model.windowsize (initBall 3) init_Map1 initPlate 2 Paused model.score initLevel1 initEnding1 0 (Door Closed 0)

init_model2 : Model -> Model
init_model2 model = 
    Model 0 model.windowsize (newBall model.ball 2) init_Map2 initPlate 2 Paused model.score initLevel2 initEnding2 0 (Door Closed 0)

init_model3 : Model -> Model
init_model3 model =
    Model 0 model.windowsize (newBall model.ball 3) init_Map3 initPlate 2 Paused model.score initLevel3 initEnding3 0 (Door Closed 0)
